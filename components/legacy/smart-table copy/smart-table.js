...
import {clearSelectionVisuals,applySelection,toggleSelection,emitSelectionChanged,clearHighlight,setHighlight, deleteSelected, selectRows } from "./utils/selectionUtils.js";
import { addRow, deleteRow, updateRow,handleHeaderClick } from "./utils/handlers.js";
...
class SmartTable extends HTMLElement {
 ...
 _onClick(e) {
  ...
  _onKeyDown(e) {
    ...
    if (e.key === "Delete") {
      ...
      if (this._selected.size > 0) {
        ...
        if (confirm(msg)) this.deleteSelected();
      }
      return;
    }
  }
  ...
  deleteRow(id) { deleteRow(this, id); }   
  updateRow(id, patch) { updateRow(this, id, patch); }
  deleteSelected() { deleteSelected(this); }  
